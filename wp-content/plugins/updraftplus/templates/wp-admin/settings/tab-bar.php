...
=======
	<a class="updraftplus-nav-tab <?php if ($tabflag == $tab_slug) echo 'nav-tab-active'; ?>" id="updraft-navtab-<?php echo $tab_slug_as_attr;?>" href="<?php echo esc_url(UpdraftPlus::get_current_clean_url());?>#updraft-navtab-<?php echo $tab_slug_as_attr;?>-content" ><?php echo $tab_label;?></a>
>>>>>>> update
<?php
}
?>
