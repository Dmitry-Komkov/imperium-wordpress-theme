...
$plugin_info = [
	...
	'load_factory_modules' => [
		...
		['libs/factory/feedback', 'factory_feedback_125', 'admin'],
		['libs/factory/processing', 'factory_processing_107', 'all'],
	],
];

$wrio_compatibility = new Wbcr_Factory469_Requirements(__FILE__, array_merge($plugin_info, [
	'plugin_already_activate' => defined('WRIO_PLUGIN_ACTIVE'),
	'required_php_version' => '7.0',
	'required_wp_version' => '4.8.0',
	'required_clearfy_check_component' => false,
